...
st.markdown("""---""")
option= st.selectbox('How would you like to import the text? Please select either browser or input', ('broswer', 'input'))
if option == 'browser':
    myword=st.file_uploader("Choose a text file")
else:
